...
describe('Prueba la navegacion y Routing del Header y Footer', () => {
    it('Prueba la navegacion del header', () => {
        ...
        cy.get('[data-cy="navegacion-header"]').find('a').eq(0).invoke('attr', 'href').should('not.equal', 'nosotros.php');
        ...
        cy.get('[data-cy="navegacion-header"]').find('a').eq(1).invoke('attr', 'href').should('not.equal', 'propiedades.php');
        ...
        cy.get('[data-cy="navegacion-header"]').find('a').eq(2).invoke('attr', 'href').should('not.equal', 'blog.php');
        ...
        cy.get('[data-cy="navegacion-header"]').find('a').eq(3).invoke('attr', 'href').should('not.equal', 'contacto.php');
        ...
        cy.get('[data-cy="navegacion-header"]').find('a').eq(4).invoke('attr', 'href').should('not.equal', 'login.php');
        cy.get('[data-cy="navegacion-header"]').find('a').eq(4).invoke('text').should('equal', 'Iniciar Sesion');
    });
    ...
    it('Prueba la navegacion del Footer', () => {
        ...
        cy.get('[data-cy="navegacion-footer"]').find('a').eq(0).invoke('attr', 'href').should('not.equal', 'nosotros.php');
        ...
        cy.get('[data-cy="navegacion-footer"]').find('a').eq(1).invoke('attr', 'href').should('not.equal', 'propiedades.php');
        ...
        cy.get('[data-cy="navegacion-footer"]').find('a').eq(2).invoke('attr', 'href').should('not.equal', 'blog.php');
        ...
        cy.get('[data-cy="navegacion-footer"]').find('a').eq(3).invoke('attr', 'href').should('not.equal', 'contacto.php');
